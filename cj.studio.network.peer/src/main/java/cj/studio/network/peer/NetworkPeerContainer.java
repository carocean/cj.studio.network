...
public class NetworkPeerContainer implements INetworkPeerContainer {
    ...
    @Override
    public INetworkPeer create(IConnection connection, String networkName, IOnopen onopen, IOnmessage onmessage, IOnclose onclose) {
        INetworkPeer networkPeer = new NetworkPeer(connection, networkName, onopen, onmessage, onclose, site);
